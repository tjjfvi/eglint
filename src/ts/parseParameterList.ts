...
export function parseParameterList(this: SourceFileNode, tsChildren: ts.Node[]){
  if(tsChildren.length !== 3)
    throw new Error("Invalid parameter list")
  return new ParameterListNode(this.finishTrivia([
...
export class ParameterListNode extends TsNodeNode {}
